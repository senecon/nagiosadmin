...
/**
 * Base class that represents a row from the 'os' table.
 *
 * 
 *
...
abstract class BaseOs extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = OsPeer::NUM_COLUMNS - OsPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * Otherwise if this Os has previously been saved, it will retrieve
	 * related Hosts from storage. If this Os is new, it will return
