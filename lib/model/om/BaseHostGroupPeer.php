...
/**
 * Base static class for performing query and update operations on the 'host_group' table.
 *
 * 
 *
...
abstract class BaseHostGroupPeer {
	...
	const OM_CLASS = 'HostGroup';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.HostGroup';

	/** the related TableMap class for this table */
	const TM_CLASS = 'HostGroupTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of HostGroup objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. HostGroupPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      HostGroup $value A HostGroup object.
	 ...
	 *
	 * @param      mixed $value A HostGroup object or a primary key value.
	 */
	 ...
	 * @return     HostGroup Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to host_group
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in HostPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseHostGroupPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseHostGroupPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new HostGroupTableMap());
	  }
	}
	...
	{
		return $withPrefix ? HostGroupPeer::CLASS_DEFAULT : HostGroupPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a HostGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HostGroup object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from HostGroup object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a HostGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HostGroup object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is HostGroup object
	...
	/**
	 * Method to DELETE all rows from the host_group table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			HostGroupPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a HostGroup or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or HostGroup object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof HostGroup) { // it's a model object
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Host objects
			$criteria = new Criteria(HostPeer::DATABASE_NAME);
			
			$criteria->add(HostPeer::GROUP_ID, $obj->getId());
			$affectedRows += HostPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}

	/**
	 * Validates all modified columns of given HostGroup object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      HostGroup $obj The object to validate.
	...
	public static function doValidate(HostGroup $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(HostGroupPeer::DATABASE_NAME, HostGroupPeer::TABLE_NAME, $columns);
	}
...
//
BaseHostGroupPeer::buildTableMap();
