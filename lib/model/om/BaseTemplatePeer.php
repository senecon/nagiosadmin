...
abstract class BaseTemplatePeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TemplatePeer::ALIAS);
		$criteria->addSelectColumn(TemplatePeer::CONTENT);
	 ...
	 *
	 * @param      Template $value A Template object.
	...
	{
		return $withPrefix ? TemplatePeer::CLASS_DEFAULT : TemplatePeer::OM_CLASS;
	}
