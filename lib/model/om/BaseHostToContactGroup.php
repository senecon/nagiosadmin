...
/**
 * Base class that represents a row from the 'host_to_contact_group' table.
 *
 * 
 *
...
abstract class BaseHostToContactGroup extends BaseObject  implements Persistent {
	 ...
	 * @return     HostToContactGroup The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = HostToContactGroupPeer::NUM_COLUMNS - HostToContactGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of HostToContactGroup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     HostToContactGroup Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getHost(PropelPDO $con = null)
	{
		if ($this->aHost === null && ($this->host_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aHost->addHostToContactGroups($this);
			 */
		}
		return $this->aHost;
	}
	...
	public function getContactGroup(PropelPDO $con = null)
	{
		if ($this->aContactGroup === null && ($this->contact_group_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aContactGroup->addHostToContactGroups($this);
			 */
		}
