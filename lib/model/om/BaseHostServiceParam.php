...
/**
 * Base class that represents a row from the 'host_service_param' table.
 *
 * 
 *
...
abstract class BaseHostServiceParam extends BaseObject  implements Persistent {
	 ...
	 * @return     HostServiceParam The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = HostServiceParamPeer::NUM_COLUMNS - HostServiceParamPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(HostServiceParamPeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of HostServiceParam (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     HostServiceParam Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getHost(PropelPDO $con = null)
	{
		if ($this->aHost === null && ($this->host_id !== null)) {
			$this->aHost = HostPeer::retrieveByPk($this->host_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aHost->addHostServiceParams($this);
			 */
		}
		return $this->aHost;
	}
	...
	public function getService(PropelPDO $con = null)
	{
		if ($this->aService === null && ($this->service_id !== null)) {
			$this->aService = ServicePeer::retrieveByPk($this->service_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aService->addHostServiceParams($this);
			 */
		}
