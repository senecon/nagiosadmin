...
/**
 * Base class that represents a row from the 'group_to_contact' table.
 *
 * 
 *
...
abstract class BaseGroupToContact extends BaseObject  implements Persistent {
	 ...
	 * @return     GroupToContact The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = GroupToContactPeer::NUM_COLUMNS - GroupToContactPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of GroupToContact (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GroupToContact Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getContactGroup(PropelPDO $con = null)
	{
		if ($this->aContactGroup === null && ($this->group_id !== null)) {
			$this->aContactGroup = ContactGroupPeer::retrieveByPk($this->group_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aContactGroup->addGroupToContacts($this);
			 */
		}
	...
	public function getContact(PropelPDO $con = null)
	{
		if ($this->aContact === null && ($this->contact_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aContact->addGroupToContacts($this);
			 */
		}
