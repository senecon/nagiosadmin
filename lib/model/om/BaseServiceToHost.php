...
/**
 * Base class that represents a row from the 'service_to_host' table.
 *
 * 
 *
...
abstract class BaseServiceToHost extends BaseObject  implements Persistent {
	 ...
	 * @return     ServiceToHost The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ServiceToHostPeer::NUM_COLUMNS - ServiceToHostPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ServiceToHost (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ServiceToHost Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getService(PropelPDO $con = null)
	{
		if ($this->aService === null && ($this->service_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aService->addServiceToHosts($this);
			 */
		}
	...
	public function getHost(PropelPDO $con = null)
	{
		if ($this->aHost === null && ($this->host_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aHost->addServiceToHosts($this);
			 */
		}
		return $this->aHost;
	}
