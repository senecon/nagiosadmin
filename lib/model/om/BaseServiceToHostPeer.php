...
/**
 * Base static class for performing query and update operations on the 'service_to_host' table.
 *
 * 
 *
...
abstract class BaseServiceToHostPeer {
	...
	const OM_CLASS = 'ServiceToHost';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.ServiceToHost';

	/** the related TableMap class for this table */
	const TM_CLASS = 'ServiceToHostTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of ServiceToHost objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ServiceToHost[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. ServiceToHostPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      ServiceToHost $value A ServiceToHost object.
	 ...
	 *
	 * @param      mixed $value A ServiceToHost object or a primary key value.
	 */
	 ...
	 * @return     ServiceToHost Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to service_to_host
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ServiceToHostPeer::getOMClass(false);
	...
	public static function doCountJoinService(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ServiceToHostPeer::SERVICE_ID, ServicePeer::ID, $join_behavior);
	...
	public static function doCountJoinHost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ServiceToHostPeer::HOST_ID, HostPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of ServiceToHost objects pre-filled with their Service objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of ServiceToHost objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinService(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ServiceToHost) to $obj2 (Service)
	...
	/**
	 * Selects a collection of ServiceToHost objects pre-filled with their Host objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of ServiceToHost objects.
	...
	public static function doSelectJoinHost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ServiceToHost) to $obj2 (Host)
				$obj2->addServiceToHost($obj1);
	...
	/**
	 * Selects a collection of ServiceToHost objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ServiceToHost) to the collection in $obj2 (Service)
				$obj2->addServiceToHost($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (ServiceToHost) to the collection in $obj3 (Host)
	...
	/**
	 * Selects a collection of ServiceToHost objects pre-filled with all related objects except Service.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptService(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ServiceToHostPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (ServiceToHost) to the collection in $obj2 (Host)
				$obj2->addServiceToHost($obj1);
	...
	/**
	 * Selects a collection of ServiceToHost objects pre-filled with all related objects except Host.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseServiceToHostPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseServiceToHostPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ServiceToHostTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ServiceToHostPeer::CLASS_DEFAULT : ServiceToHostPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ServiceToHost or Criteria object.
	 *
	 * @param      mixed $values Criteria or ServiceToHost object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ServiceToHost object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ServiceToHost or Criteria object.
	 *
	 * @param      mixed $values Criteria or ServiceToHost object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is ServiceToHost object
	...
	/**
	 * Method to DELETE all rows from the service_to_host table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			ServiceToHostPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a ServiceToHost or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ServiceToHost object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ServiceToHost) { // it's a model object
	...
	/**
	 * Validates all modified columns of given ServiceToHost object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ServiceToHost $obj The object to validate.
	...
	public static function doValidate(ServiceToHost $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(ServiceToHostPeer::DATABASE_NAME, ServiceToHostPeer::TABLE_NAME, $columns);
	}
...
} // BaseServiceToHostPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseServiceToHostPeer::buildTableMap();
