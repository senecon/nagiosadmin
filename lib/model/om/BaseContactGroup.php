...
/**
 * Base class that represents a row from the 'contact_group' table.
 *
 * 
 *
...
abstract class BaseContactGroup extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array GroupToContact[] Collection to store aggregation of GroupToContact objects.
	 */
	protected $collGroupToContacts;

	/**
	 * @var        Criteria The criteria used to select the current contents of collGroupToContacts.
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ContactGroupPeer::NUM_COLUMNS - ContactGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(ContactGroupPeer::CREATED_AT))
				{
	...
	/**
	 * Clears out the collGroupToContacts collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addGroupToContacts()
	 */
	public function clearGroupToContacts()
	{
		$this->collGroupToContacts = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collGroupToContacts collection (array).
	 *
	 * By default this just sets the collGroupToContacts collection to an empty array (like clearcollGroupToContacts());
	...
	/**
	 * Gets an array of GroupToContact objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this ContactGroup has previously been saved, it will retrieve
	 * related GroupToContacts from storage. If this ContactGroup is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array GroupToContact[]
	 * @throws     PropelException
	 */
	...
	/**
	 * Returns the number of related GroupToContact objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related GroupToContact objects.
	 * @throws     PropelException
	 */
	public function countGroupToContacts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collGroupToContacts === null) {
			if ($this->isNew()) {
				...
				$count = GroupToContactPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a GroupToContact object to this object
	 * through the GroupToContact foreign key attribute.
	 *
	 * @param      GroupToContact $l GroupToContact
	 * @return     void
	 * @throws     PropelException
	 */
	public function addGroupToContact(GroupToContact $l)
	{
		...
		if (!in_array($l, $this->collGroupToContacts, true)) { // only add it if the **same** object is not already associated
			array_push($this->collGroupToContacts, $l);
	 ...
	 * Otherwise if this ContactGroup is new, it will return
	 * an empty collection; or if this ContactGroup has previously
	 * been saved, it will retrieve related GroupToContacts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ContactGroup.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this ContactGroup has previously been saved, it will retrieve
	 * related HostToContactGroups from storage. If this ContactGroup is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
