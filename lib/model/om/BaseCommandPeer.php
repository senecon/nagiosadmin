...
abstract class BaseCommandPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CommandPeer::ID, CommandPeer::NAME, CommandPeer::ALIAS, CommandPeer::COMMAND, CommandPeer::CREATED_AT, CommandPeer::UPDATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CommandPeer::ID => 0, CommandPeer::NAME => 1, CommandPeer::ALIAS => 2, CommandPeer::COMMAND => 3, CommandPeer::CREATED_AT => 4, CommandPeer::UPDATED_AT => 5, ),
	...
	{
		include_once 'lib/model/map/CommandMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CommandMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = CommandPeer::getTableMap();
	...
	const COUNT = 'COUNT(command.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT command.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(CommandPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(CommandPeer::COUNT);
		}
		...
		$rs = CommandPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return CommandPeer::populateObjects(CommandPeer::doSelectRS($criteria, $con));
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CommandPeer::ID); 
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += CommandPeer::doOnDeleteCascade(new Criteria(), $con);
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Command) {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/Service.php';
...
if (Propel::isInit()) {
			try {
		BaseCommandPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			require_once 'lib/model/map/CommandMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CommandMapBuilder');
}
