...
/**
 * Base static class for performing query and update operations on the 'command' table.
 *
 * 
 *
...
abstract class BaseCommandPeer {
	...
	const TM_CLASS = 'CommandTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of Command objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. CommandPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Command $value A Command object.
	 ...
	 *
	 * @param      mixed $value A Command object or a primary key value.
	 */
	 ...
	 * @return     Command Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to command
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseCommandPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseCommandPeer::TABLE_NAME))
	  {
	...
	{
		return $withPrefix ? CommandPeer::CLASS_DEFAULT : CommandPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Command or Criteria object.
	 *
	 * @param      mixed $values Criteria or Command object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Command object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Command or Criteria object.
	 *
	 * @param      mixed $values Criteria or Command object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the command table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			CommandPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Command or Criteria object OR a primary key value.
	 *
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ServicePeer::COMMAND_ID, $obj->getId());
	...
	/**
	 * Validates all modified columns of given Command object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Command $obj The object to validate.
	...
	public static function doValidate(Command $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(CommandPeer::DATABASE_NAME, CommandPeer::TABLE_NAME, $columns);
	}
