...
/**
 * Base static class for performing query and update operations on the 'os' table.
 *
 * 
 *
...
abstract class BaseOsPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Os objects.
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new OsTableMap());
	  }
	}
	...
	{
		return $withPrefix ? OsPeer::CLASS_DEFAULT : OsPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Os or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Os or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the os table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Os or Criteria object OR a primary key value.
	 *
