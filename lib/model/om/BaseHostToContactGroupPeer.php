...
/**
 * Base static class for performing query and update operations on the 'host_to_contact_group' table.
 *
 * 
 *
...
abstract class BaseHostToContactGroupPeer {
	...
	const OM_CLASS = 'HostToContactGroup';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.HostToContactGroup';

	/** the related TableMap class for this table */
	const TM_CLASS = 'HostToContactGroupTableMap';
	...
	/** the column name for the CONTACT_GROUP_ID field */
	const CONTACT_GROUP_ID = 'host_to_contact_group.CONTACT_GROUP_ID';

	/**
	 * An identiy map to hold any loaded instances of HostToContactGroup objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array HostToContactGroup[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. HostToContactGroupPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      HostToContactGroup $value A HostToContactGroup object.
	 ...
	 *
	 * @param      mixed $value A HostToContactGroup object or a primary key value.
	 */
	 ...
	 * @return     HostToContactGroup Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to host_to_contact_group
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = HostToContactGroupPeer::getOMClass(false);
	...
	public static function doCountJoinHost(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(HostToContactGroupPeer::HOST_ID, HostPeer::ID, $join_behavior);
	...
	public static function doCountJoinContactGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(HostToContactGroupPeer::CONTACT_GROUP_ID, ContactGroupPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of HostToContactGroup objects pre-filled with their Host objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of HostToContactGroup objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinHost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HostToContactGroup) to $obj2 (Host)
	...
	/**
	 * Selects a collection of HostToContactGroup objects pre-filled with their ContactGroup objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of HostToContactGroup objects.
	...
	public static function doSelectJoinContactGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HostToContactGroup) to $obj2 (ContactGroup)
				$obj2->addHostToContactGroup($obj1);
	...
	/**
	 * Selects a collection of HostToContactGroup objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HostToContactGroup) to the collection in $obj2 (Host)
				$obj2->addHostToContactGroup($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (HostToContactGroup) to the collection in $obj3 (ContactGroup)
	...
	/**
	 * Selects a collection of HostToContactGroup objects pre-filled with all related objects except Host.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptHost(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = HostToContactGroupPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (HostToContactGroup) to the collection in $obj2 (ContactGroup)
				$obj2->addHostToContactGroup($obj1);
	...
	/**
	 * Selects a collection of HostToContactGroup objects pre-filled with all related objects except ContactGroup.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseHostToContactGroupPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseHostToContactGroupPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new HostToContactGroupTableMap());
	  }
	}
	...
	{
		return $withPrefix ? HostToContactGroupPeer::CLASS_DEFAULT : HostToContactGroupPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a HostToContactGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HostToContactGroup object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from HostToContactGroup object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a HostToContactGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HostToContactGroup object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is HostToContactGroup object
	...
	/**
	 * Method to DELETE all rows from the host_to_contact_group table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			HostToContactGroupPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a HostToContactGroup or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or HostToContactGroup object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof HostToContactGroup) { // it's a model object
	...
	/**
	 * Validates all modified columns of given HostToContactGroup object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      HostToContactGroup $obj The object to validate.
	...
	public static function doValidate(HostToContactGroup $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(HostToContactGroupPeer::DATABASE_NAME, HostToContactGroupPeer::TABLE_NAME, $columns);
	}
...
} // BaseHostToContactGroupPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseHostToContactGroupPeer::buildTableMap();
